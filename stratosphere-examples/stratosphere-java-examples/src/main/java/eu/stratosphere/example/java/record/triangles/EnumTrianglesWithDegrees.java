...
import eu.stratosphere.example.java.record.triangles.ComputeEdgeDegrees.CountEdges;
import eu.stratosphere.example.java.record.triangles.ComputeEdgeDegrees.JoinCountsAndUniquify;
import eu.stratosphere.example.java.record.triangles.ComputeEdgeDegrees.ProjectEdge;
import eu.stratosphere.example.java.record.triangles.EnumTrianglesOnEdgesWithDegrees.BuildTriads;
import eu.stratosphere.example.java.record.triangles.EnumTrianglesOnEdgesWithDegrees.CloseTriads;
import eu.stratosphere.example.java.record.triangles.EnumTrianglesOnEdgesWithDegrees.ProjectOutCounts;
import eu.stratosphere.example.java.record.triangles.EnumTrianglesOnEdgesWithDegrees.ProjectToLowerDegreeVertex;
