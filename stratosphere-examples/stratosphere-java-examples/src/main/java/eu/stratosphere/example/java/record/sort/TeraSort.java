...
import eu.stratosphere.example.java.record.sort.terasort.TeraDistribution;
import eu.stratosphere.example.java.record.sort.terasort.TeraInputFormat;
import eu.stratosphere.example.java.record.sort.terasort.TeraKey;
import eu.stratosphere.example.java.record.sort.terasort.TeraOutputFormat;
